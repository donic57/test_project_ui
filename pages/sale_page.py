...
class SalePage(BasePage):
    ...
    def check_quantity_items_in_pages(self, text):
        ...
        quantity_items = int(self.find(loc.quantity_items_loc).text)
    ...
    def check_page_gear(self, text1, text2):
        self.driver.execute_script('window.scrollTo(0, document.body.scrollHeight);')
        ...
        text_gear = self.find(loc.base_loc).text
        assert text_gear == text1
        WebDriverWait(self.driver, 10).until(
